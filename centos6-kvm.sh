...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.github.com/kazmigithub/webeudp53/master/conf/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.github.com/kazmigithub/webeudp53/master/conf/1194-centos.conf"
if [ "$OS" == "x86_64" ]; then
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.github.com/kazmigithub/webeudp53/master/conf/1194-client.conf"
